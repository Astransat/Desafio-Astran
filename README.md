# Como roda a aplicação
  Antes de rodar a aplicação é necessário entrar nos diretórios "backend" e "frontend" e instalar todas as dependências.
  Após isso, e tendo o Docker e Docker-compose no pc, apenas digite no terminal dentro do diretório da pasta raiz: docker-compose up
...
# Rodar os testes
  ...
  portanto os últimos testes podem sofrer erros devido ao limite de chamadas da AplhaVantage. Sendo o limite 5 chamadas por minuto, para reparar isso é necessário apenas comentar dois ou mais testes anteriores do mesmo arquivo.
  ...
  nos últimos testes devido ao limite de chamadas. A solução novamente é comentar dois ou mais testes dentro do arquivo.
